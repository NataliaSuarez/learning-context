...
const ContadorProvider = ({ children }) => {
  ...
  const incrementar = useCallback(() => setContador((total) => total + 1), []);
  const decrementar = useCallback(() => setContador((total) => total - 1), []);
...
/** CASO - LOS DATOS DEL CONTEXTO CAMBIAN CONSTANTEMENTE ===> en ese caso usamos REDUX */
// aunque utilicemos memoization
